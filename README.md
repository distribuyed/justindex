...
|	Project	| URL	| REPO | Whitepaper/Docs | Blog | 	Contact	| 	Protocol	| DLT | ORG |
| ------------- |:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|------------- |
...
If you know in details or are you the owner/dev of any justidex project, please fill the column with all the codes that correspond creating an [issue](https://github.com/distribuyed/index/issues) or [pull request](https://github.com/distribuyed/index/pulls) to suggest changes to this file.
